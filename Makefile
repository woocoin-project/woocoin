...
pkgdatadir = $(datadir)/woocoin
pkgincludedir = $(includedir)/woocoin
pkglibdir = $(libdir)/woocoin
pkglibexecdir = $(libexecdir)/woocoin
...
ACLOCAL = ${SHELL} /woocoin/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /woocoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /woocoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /woocoin/build-aux/missing automake-1.15
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = woocoin-cli
BITCOIN_DAEMON_NAME = woocoind
BITCOIN_GUI_NAME = woocoin-qt
BITCOIN_TX_NAME = woocoin-tx
...
COPYRIGHT_HOLDERS_FINAL = The WooCoin Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = WooCoin Core
COPYRIGHT_YEAR = 2018
CPP = gcc -E
...
MAINT = 
MAKEINFO = ${SHELL} /woocoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = woocoin
PACKAGE_BUGREPORT = https://github.com/woocoin-project/woocoin/issues
PACKAGE_NAME = WooCoin Core
PACKAGE_STRING = WooCoin Core 0.16.1
PACKAGE_TARNAME = woocoin
PACKAGE_URL = https://woocoin.org/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /woocoin
abs_srcdir = /woocoin
abs_top_builddir = /woocoin
abs_top_srcdir = /woocoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /woocoin/build-aux/install-sh
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/WooCoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/MacOS/WooCoin-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/WooCoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/WooCoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)

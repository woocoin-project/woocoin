...
* woocoin.conf: contains configuration settings for woocoind or woocoin-qt
* woocoind.pid: stores the process id of woocoind while running
...
* debug.log: contains debug information and general logging generated by woocoind or woocoin-qt

...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s woocoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  woocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded woocoin transaction") + "\n" +
              "  woocoin-tx [options] -create [commands]   " + _("Create hex-encoded woocoin transaction") + "\n" +
              "\n";

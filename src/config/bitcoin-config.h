...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The WooCoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "WooCoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/woocoin-project/woocoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "WooCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "WooCoin Core 0.16.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "woocoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://woocoin.org/"

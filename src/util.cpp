...
const char * const BITCOIN_CONF_FILENAME = "woocoin.conf";
const char * const BITCOIN_PID_FILENAME = "woocoind.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "WooCoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/WooCoin";
#else
    // Unix
    return pathRet / ".woocoin";
#endif
#endif
}

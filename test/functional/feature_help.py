...
"""Verify that starting woocoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start woocoin with -h for help text")
        ...
        self.log.info("Start woocoin with -version for version information")
